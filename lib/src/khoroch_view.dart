...
import 'package:khoroch/src/local/expenditure.dart';
import 'package:khoroch/src/local/show_balance.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

import 'package:khoroch/core/extensions.dart';
import 'package:khoroch/services/services.dart';
import 'package:khoroch/src/local/user_card.dart';
import 'package:khoroch/theme/theme.dart';
import 'package:khoroch/widgets/widgets.dart';

class KhorochPage extends ConsumerWidget {
                        ...
                        child: Column(
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                ...users
                                    .map((user) => PersonCashCard(user: user)),
                              ],
                            ),
